...
Il contient aussi des modules séparées qui reprennent ces même codes, mais en les séparant. Ils sont stockés dans le dossier graphe_seine. Les ficheirs visu_dist.py et visu_oriented.py permettent une visualisation plus interactive des graphes. 
